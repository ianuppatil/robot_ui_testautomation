...
${SEARCH_RESULTS_FALLBACK_LOCATOR}     css=[data-cy='title-recipe']
...
${SEARCH_RESULT_PRODUCT_LINK_FALLBACK_LOCATOR}    css=[data-cy='title-recipe'] .a-link-normal.s-line-clamp-2.s-link-style.a-text-normal
